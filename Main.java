  ...
  public static void main(String[] args) {
    ...
    while(true) {
      ...
      if (choice.equals("scissors") || choice.equals("Scissors")) {
        System.out.println("\nYou lose. The computer chose rock. Better luck next time :(\n\n");
      }
        ...
        System.out.println("\nThe computer chose paper. I know this news may be hard to take but I'm sure you can make it through. I'm here for support. You'll probably win next time.\n\n");
      }
